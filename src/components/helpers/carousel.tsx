...
import { CarouselSlideOne, CarouselSlideTwo, CarouselSlideThree, CarouselSlideFour } from '@assets/images';

const sliders = [CarouselSlideOne, CarouselSlideTwo, CarouselSlideThree, CarouselSlideFour]
