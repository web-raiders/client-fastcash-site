...
export const qualifications = [
    {
        ...
        description: 'We understand that financial needs can arise at any moment, which is why we offer a secure, transparent, and hassle-free way to access the funds you need—whenever you need them.',
        icon: MdOutlineEnergySavingsLeaf
    },
    {
        title: 'Speed & Convenience',
        description: 'Say goodbye to long application processes—our fully digital loan platform allows you to apply, get approved, and receive funds in just a few simple steps.',
        icon: MdOutlineEnergySavingsLeaf
    },
    {
        title: 'Affordability & Flexibility',
        description: 'We believe that financial support should be accessible to everyone, which is why we offer flexible repayment plans that fit your lifestyle and budget.',
        icon: MdOutlineEnergySavingsLeaf
    },
    {
        title: 'Innovation & Accessibility',
        description: 'With our easy-to-use platform, you can apply for a loan from the comfort of your home, track your application in real time, and access funds without unnecessary paperwork.',
        icon: MdOutlineEnergySavingsLeaf
    },
]
...
export const coreValues = [
    {
        icon: MdOutlineEnergySavingsLeaf,
        title: 'Excellence',
        description: 'Striving for exceptional quality and performance in everything we do, exceeding expectations and setting new standards.'
    },
    {
        icon: MdOutlineEnergySavingsLeaf,
        title: 'Ethics',
    ...
    },
    {
        icon: MdOutlineEnergySavingsLeaf,
        title: 'Trust',
        description: 'Earning and maintaining confidence through dependable actions, open communication, and unwavering commitment to our customers and stakeholders.'
    },
    {
        icon: MdOutlineEnergySavingsLeaf,
...
export const solutions = [
    {
        ...
        title: 'Speed',
        description: 'Receive the funds you need in less than 3 hours, hassle-free.'
    },
    {
    ...
    },
    {
        icon: GiBamboo,
        title: 'Transparency',
        description: 'No hidden fees or surprises—just clear and honest loan terms.'
    },
]
...
export const contactList = [
    {
        icon: SlLocationPin,
        title: 'Head Office',
        headingOne: 'Ikeja Town Square Mall, 131 Obafemi Awolowo Way Ikeja',
        headingTwo: 'Lagos Nigeria',
    },
    {
        icon: SlLocationPin,
        title: 'Abuja Office',
        headingOne: '3 Port Harcourt Crescent Gimbiya Street Area 11 Garki',
